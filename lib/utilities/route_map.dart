...
import 'dart:convert';
import 'package:em_friend/dependency/latlngz.dart' as latlat;

import '../dependency/flexible_polyline.dart';
...
class RoutePage extends StatefulWidget {
  ...
  RoutePage({required this.origin, required this.dest});
  final LatLng origin;
  final LatLng dest;
}
...
class _RoutePageState extends State<RoutePage> {
  ...
  void _searchPlace(String query) async {
    ...
    final String altUrl =
        "https://geocode.search.hereapi.com/v1/geocode?q=City+Mall&apiKey=$apiKey";
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            print(snapshot.data);
            var route = snapshot.data!['routes'][0]['sections'][0]['polyline'];
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return ListTile(
                                ...
                                subtitle: Text("Lat : " +
                                    place['position']['lat'].toString() +
                                    " Long : " +
                                    place['position']['lng'].toString()),
                              );
                            },
                          ),
                        ),
  ...
  Future<Map<String, dynamic>> _getRoute() async {
    ...
    final url = Uri.parse(
        'https://router.hereapi.com/v8/routes?transportMode=car&origin=${widget.origin.latitude},${widget.origin.longitude}&destination=${widget.dest.latitude},${widget.dest.longitude}&return=polyline&apiKey=$apiKey');
